...
interface QueryGitHubService{
    ...
    fun getReposWithQueryInName(@Query("q") query: String,@Query("per_page") pageSize : Int = 11,@Query("page") pageNumber : Int = 1) : Single<GitHubApiQueryResponse<BasicGitHubRepoResponse>>
}